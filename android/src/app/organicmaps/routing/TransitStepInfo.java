...
public class TransitStepInfo
{
  ...
  private static final int TRANSIT_TYPE_HELICOPTER = 6;

  @Retention(RetentionPolicy.SOURCE)
  @IntDef({ TRANSIT_TYPE_INTERMEDIATE_POINT, TRANSIT_TYPE_PEDESTRIAN, TRANSIT_TYPE_SUBWAY,
            TRANSIT_TYPE_TRAIN, TRANSIT_TYPE_LIGHT_RAIL, TRANSIT_TYPE_MONORAIL, TRANSIT_TYPE_HELICOPTER})
  ...
  @NonNull
  public static TransitStepInfo helicopter(@NonNull String distance, @NonNull String distanceUnits)
  {
    return new TransitStepInfo(TRANSIT_TYPE_HELICOPTER, distance, distanceUnits, 0, null, 0, -1);
  }
